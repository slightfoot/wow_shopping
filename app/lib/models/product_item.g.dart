...
ProductItem _$ProductItemFromJson(Map json) => ProductItem(
  ...
  options:
      (json['options'] as List<dynamic>?)?.map((e) => ProductOption.fromJson(e as Map)).toList() ??
      const [],
);

Map<String, dynamic> _$ProductItemToJson(ProductItem instance) => <String, dynamic>{
  'id': instance.id,
...
Map<String, dynamic> _$ProductOptionToJson(ProductOption instance) => <String, dynamic>{
  'id': instance.id,
  'name': instance.name,
};
